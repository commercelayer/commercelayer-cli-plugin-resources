...
_See code: [src/commands/resources/update.ts](https://github.com/commercelayer/commercelayer-cli-plugin-resources/blob/v1.0.0-beta.16/src/commands/resources/update.ts)_
<!-- commandsstop -->
